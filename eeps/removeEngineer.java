...
public class removeEngineer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        id.setFont(new java.awt.Font("DejaVu Sans Condensed", 1, 24)); // NOI18N
        id.setText("  ");
        ...
        getContentPane().add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 50, 30));
        ...
        getContentPane().add(Engineer, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 430, 150, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eeps/Images/RemoveEngineer.png"))); // NOI18N
    ...
    private void EngineerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EngineerMouseClicked
        ...
        tempEng.deleteEngineer(id.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new removeEngineer().setVisible(true);
            }
        });
