...
public class AddTrainee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, 130, 20));

        payRate.setBackground(new java.awt.Color(250, 243, 243));
        payRate.setFont(new java.awt.Font("DejaVu Sans Condensed", 0, 12)); // NOI18N
        payRate.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        getContentPane().add(payRate, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 320, 130, 20));
        ...
        getContentPane().add(workingHours, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 390, 130, 20));
        ...
        getContentPane().add(position, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 320, 130, 20));
        ...
        getContentPane().add(age, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 260, 130, 20));
        ...
        getContentPane().add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 40, 30));
        ...
        getContentPane().add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 440, 110, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eeps/Images/AddTrainee.png"))); // NOI18N
    ...
    private void AddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddMouseClicked
        ...
        tempTrain.AddTrainee(name.getText(), Integer.parseInt(age.getText()) , workingHours.getText() , Double.parseDouble(position.getText()), Integer.parseInt(payRate.getText()));
        id.setText(Integer.toString(tempTrain.getId()));
